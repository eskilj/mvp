...
class Immune extends Canvas implements Runnable {
    ...
    public void run() {
        while (true) {
            ...
            try{
                ...
                float[] waveStream = new float[100];
                float[] sweepCounter  = new float[100];
                
                float frac[] = new float[5];
                ...
                for(int x = 0; x < 100; x++){
                    ...
                    // initialize the lattice the new time
                    for (int i=0; i<size; i++) {
                        for (int j=0; j<size; j++) {
                            
                            if ((Math.random() < 0.99) && (Math.random() > p1Frac)){
                                s[i][j] = 1;
                            }
                            else if(Math.random() < p1Frac){
                                s[i][j] = 7;
                            }
                            else{
                                s[i][j] = -1;
                    ...
                    while(!immune){
                        ...
                        if (cellFlip == N){
                            ...
                            if (fracCounter < 5){
                                ...
                                if((frac[0] >= frac[1]) && (frac[1] >= frac[2]) && (frac[2] >= frac[3]) && (frac[3] >= frac[4]) ) {
                                
                                    waveStream[x] = (float)nInfected / (float)N;
                                    sweepCounter[x] = (float)p1 ;
                                    immune = true;
                                    p1Frac = 0;
                                    p1 += 0.01;
                    ...
                    PrintWriter wavefunc = new PrintWriter(new FileWriter("immune.txt"));
        ...
        void colorSquare(int i, int j) {
            ...
            else if (s[i][j] == -1) offScreenGraphics.setColor(rColor);
